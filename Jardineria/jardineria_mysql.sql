...
-- Volcando estructura de base de datos para jardineria
CREATE DATABASE IF NOT EXISTS `jardineria` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `jardineria`;

-- Volcando estructura para tabla jardineria.cliente
...
-- Volcando datos para la tabla jardineria.cliente: ~36 rows (aproximadamente)
/*!40000 ALTER TABLE `cliente` DISABLE KEYS */;
REPLACE INTO `cliente` (`codigo_cliente`, `nombre_cliente`, `nombre_contacto`, `apellido_contacto`, `telefono`, `fax`, `linea_direccion1`, `linea_direccion2`, `ciudad`, `region`, `pais`, `codigo_postal`, `codigo_empleado_rep_ventas`, `limite_credito`) VALUES
...
-- Volcando estructura para tabla jardineria.detalle_pedido
...
-- Volcando datos para la tabla jardineria.detalle_pedido: ~318 rows (aproximadamente)
/*!40000 ALTER TABLE `detalle_pedido` DISABLE KEYS */;
REPLACE INTO `detalle_pedido` (`codigo_pedido`, `codigo_producto`, `cantidad`, `precio_unidad`, `numero_linea`) VALUES
	(1, 'FR-67', 10, 70.00, 3),
	(1, 'OR-127', 40, 4.00, 1),
	(1, 'OR-141', 25, 4.00, 2),
	(1, 'OR-241', 15, 19.00, 4),
...
-- Volcando estructura para tabla jardineria.empleado
...
-- Volcando datos para la tabla jardineria.empleado: ~31 rows (aproximadamente)
/*!40000 ALTER TABLE `empleado` DISABLE KEYS */;
REPLACE INTO `empleado` (`codigo_empleado`, `nombre`, `apellido1`, `apellido2`, `extension`, `email`, `codigo_oficina`, `codigo_jefe`, `puesto`) VALUES
...
-- Volcando estructura para tabla jardineria.gama_producto
...
-- Volcando datos para la tabla jardineria.gama_producto: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `gama_producto` DISABLE KEYS */;
REPLACE INTO `gama_producto` (`gama`, `descripcion_texto`, `descripcion_html`, `imagen`) VALUES
...
-- Volcando estructura para tabla jardineria.oficina
...
-- Volcando datos para la tabla jardineria.oficina: ~9 rows (aproximadamente)
/*!40000 ALTER TABLE `oficina` DISABLE KEYS */;
REPLACE INTO `oficina` (`codigo_oficina`, `ciudad`, `pais`, `region`, `codigo_postal`, `telefono`, `linea_direccion1`, `linea_direccion2`) VALUES
...
-- Volcando estructura para tabla jardineria.pago
...
-- Volcando datos para la tabla jardineria.pago: ~26 rows (aproximadamente)
/*!40000 ALTER TABLE `pago` DISABLE KEYS */;
REPLACE INTO `pago` (`codigo_cliente`, `forma_pago`, `id_transaccion`, `fecha_pago`, `total`) VALUES
...
-- Volcando estructura para tabla jardineria.pedido
...
-- Volcando datos para la tabla jardineria.pedido: ~115 rows (aproximadamente)
/*!40000 ALTER TABLE `pedido` DISABLE KEYS */;
REPLACE INTO `pedido` (`codigo_pedido`, `fecha_pedido`, `fecha_esperada`, `fecha_entrega`, `estado`, `comentarios`, `codigo_cliente`) VALUES
...
CREATE TABLE IF NOT EXISTS `producto` (
  ...
  KEY `gama` (`gama`),
  CONSTRAINT `producto_ibfk_1` FOREIGN KEY (`gama`) REFERENCES `gama_producto` (`gama`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Volcando datos para la tabla jardineria.producto: ~276 rows (aproximadamente)
/*!40000 ALTER TABLE `producto` DISABLE KEYS */;
REPLACE INTO `producto` (`codigo_producto`, `nombre`, `gama`, `dimensiones`, `proveedor`, `descripcion`, `cantidad_en_stock`, `precio_venta`, `precio_proveedor`) VALUES
